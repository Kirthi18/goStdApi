...
func main() {
	...
	// app.Listen(":8000")
	log.Fatal(http.ListenAndServe(":9080", handlers.CORS(handlers.AllowedMethods([]string{"HEAD", "GET", "POST", "PUT", "DELETE"}), handlers.AllowedOrigins([]string{"*"}), handlers.AllowedHeaders([]string{"authentication", "Content-Type"}), handlers.AllowCredentials())(r)))
}
